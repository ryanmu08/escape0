...
let haveSword = sprites.create(img`
. . . . f f f f f f . . . . . . . . . . . . . . 
. . f f e e e e f 2 f . . . . . . . . . . . . . 
...
war = sprites.allOfKind(SpriteKindLegacy.sword)
info.setLife(3)
